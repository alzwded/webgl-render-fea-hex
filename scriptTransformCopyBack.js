...
function setup_scene() {
    ...
    gl.bufferData(gl.TRANSFORM_FEEDBACK_BUFFER, 4 * (prim.coords.length * 4 + prim.coords.length * 4 + prim.coords.length * 3), gl.STATIC_READ)
    ...
    state.render = (() => {
        ...
        gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(cornersData), gl.STATIC_DRAW)
        gl.bindBuffer(gl.ARRAY_BUFFER, null)

        let tCoordsBuffer = gl.createBuffer()
        gl.bindBuffer(gl.ARRAY_BUFFER, tCoordsBuffer)
        gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(displacedData), gl.STATIC_DRAW)
        gl.bindBuffer(gl.ARRAY_BUFFER, null)
...
function main() {
    ...
    gl.transformFeedbackVaryings(transformProgram, feedbackVarying, gl.INTERLEAVED_ATTRIBS)
